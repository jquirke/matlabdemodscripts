function eq_kv = lte_symbol_eq( kvector, kvest0, kvest1, NDLRB, ncellid, l, ns, ncp )
...
%this is not the case elsewhere (apparently)
    ...
    elseif (l == 1 && ns == 1) %special case, there are no reference signals in this 2x2-only code, but, PBCH assumes there are
