...
%     PB=ref signal symbols
    ...
    pb_pa = PB_tab(numtxantennas, PB+1);
    pb_pa_sqrt = sqrt(pb_pa); %square root gives the voltage ratio
    ...
    prb_symbols = (prb_symbols .* (PB_map ./ pb_pa_sqrt)) + (prb_symbols .* (1- PB_map)); %divide the PB power by PB/PA (i.e. PA.PB/PB =PA) to get PA power
